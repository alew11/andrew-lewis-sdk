...
public class LotrMovieAPIResponseModel {
    ...
    public LotrMovieAPIResponseModel(List<Movie> docs, int total, int limit, int offset, int page, int pages) {
        this.docs = docs;
        this.total = total;
        this.limit = limit;
        this.offset = offset;
    ...
    public LotrMovieAPIResponseModel() {
    }
    ...
    public boolean equals(Object o) {
        ...
        LotrMovieAPIResponseModel that = (LotrMovieAPIResponseModel) o;
